...
const DiscordIcon: React.FC<DiscordIconProps> = ({ color }) => {
  return (
    <div style={{ fontSize: "20px", marginLeft: "8px", marginBottom: "0px" }}>
      <svg
        width="1em"
        height="1.3em"
        viewBox="0 0 71 71"
